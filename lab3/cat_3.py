...
brushColor("white") #window
x = 550; y = 20; s = 1
obj = rectangle(x, y, x+180/s, y+260/s)
s = 1.5
obj1 = rectangle(x, y, x+180/s, y+260/s)
s = 2
obj2 = rectangle(x, y, x+180/s, y+260/s)

brushColor(2,145,217)
x = 310; y = -290; s = 1
obj3 = rectangle(x+20/s, y+20/s, x+160/s, y+240/s)
x = 150; s = 1.5
obj4 = rectangle(x+20/s, y+20/s, x+160/s, y+240/s)
x = 20; s = 2
obj5 = rectangle(x+20/s, y+20/s, x+160/s, y+240/s)

penColor(255,255,255)
brushColor("white") #window

x = 550; y = 20; s = 1 
obj6 = rectangle(x+85/s, y+20/s, x+95/s, y+240/s)#вертикальный переплет
x = 550; y = 20; s = 1.5 
obj7 = rectangle(x+85/s, y+20/s, x+95/s, y+240/s)#вертикальный переплет
x = 550; y = 20; s = 2 
obj8 = rectangle(x+85/s, y+20/s, x+95/s, y+240/s)#вертикальный переплет
x = 550; y = 20; s = 2 
obj9 = rectangle(x+18/s, y+90/s, x+160/s, y+100/s)
x = 550; y = 20; s = 1.5 
obj10 = rectangle(x+18/s, y+90/s, x+160/s, y+100/s)
x = 550; y = 20; s = 1 
obj11 = rectangle(x+18/s, y+90/s, x+160/s, y+100/s)

def update():
    if xCoord(obj) >= 310:
        moveObjectBy(obj, -10, 0)
    if xCoord(obj11) >= 310 + 19:
        moveObjectBy(obj11, -10, 0)    
    if xCoord(obj1) >= 150:
        moveObjectBy(obj1, -10, 0)
    if xCoord(obj2) >= 20:
        moveObjectBy(obj2, -10, 0)
    if xCoord(obj8) >= 20 + 45:
        moveObjectBy(obj8, -10, 0)    
    if xCoord(obj7) >= 150 + 60:
        moveObjectBy(obj7, -10, 0)
    if xCoord(obj6) >= 310 + 85:
        moveObjectBy(obj6, -10, 0)
    if xCoord(obj9) >= 20 + 9.5:
        moveObjectBy(obj9, -10, 0)
    if xCoord(obj10) >= 150 + 12:
        moveObjectBy(obj10, -10, 0)

        
     
    if yCoord(obj3) <= 20 + 19:
        moveObjectBy(obj3, 0, 2)
    if yCoord(obj4) <= 20 + 12:
        moveObjectBy(obj4, 0, 2)
    if yCoord(obj5) <= 20 + 9.5:
        moveObjectBy(obj5, 0, 2)
